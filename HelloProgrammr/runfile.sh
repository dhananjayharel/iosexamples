...
if [ -f "$FILE" ]; then
    echo "ok"
    cd $curdir
    curl -s https://tok_fpym7vqveexadk8t3m9ru9cg7m@api.appetize.io/v1/apps -F "file=@/home/project/BlazorConnectFour/1584118476176/HelloProgrammr/HelloProgrammr.app.zip" -F "platform=ios" > .outputurl
